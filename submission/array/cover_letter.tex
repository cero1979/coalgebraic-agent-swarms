...
The version-matched, anonymous software and synthetic data are supplied as a
separate supplementary archive for peer review. We will add an anonymous
repository link only after verifying that the revised snapshot is accessible
without authentication and contains no author-identifying material.
