...
The version-matched, anonymous software and synthetic data are available from
the anonymous repository cited in the manuscript and supplied as a separate
supplementary archive for peer review. The review
snapshot includes the editable anonymous manuscript and excludes identified
editorial files and repository history.
